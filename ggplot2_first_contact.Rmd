...
```{r}
sepalPlot <- p + geom_point(aes(x=Sepal.Length, y=Sepal.Width), size=3) + scale_color_npg()
petalPlot <- p + geom_point(aes(x=Petal.Length, y=Petal.Width), size=3) + scale_color_npg()
